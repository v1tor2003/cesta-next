...
export default function Header({showToggle, isNavOpen,toggleNav}: HeaderProps) {
  ...
  return (
    <header className={`shadow transition-all duration-300 flex fixed top-0 left-0 right-0 z-10 w-full h-16 md:h-20 bg-white justify-between items-center p-6`}>
