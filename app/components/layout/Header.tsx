...
export default function Header({ showToggle, isNavOpen, toggleNav }: HeaderProps) {
  ...
  return (
    <header className={`col-span-2 shadow transition-all duration-300 flex fixed top-0 left-0 right-0 z-1599 xs:relative w-full h-16 md:h-20 bg-white justify-between items-center p-6`}>
